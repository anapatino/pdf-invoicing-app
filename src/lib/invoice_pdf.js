...
function addPaymentMethods(doc, methodOfPayment, servicesLength) {
  ...
  const textY = 220 + 30 * (servicesLength + 1) + 275;
  ...
  paymentMethods.forEach((method, index) => {
    ...
    doc
      .fillColor("black")
      .fontSize(12)
      .text(method + ":", currentX + 80, textY);
    if (method !== "Bancolombia") {
      doc
        .fillColor("black")
        .fontSize(10)
        .text(paymentAmounts[index], currentX + 80, textY + 15);
    }
    ...
    if (
      ...
      doc
        .fontSize(10)
        .text(`Cuenta ${bancolombiaData.account}`, currentX + 80, textY + 15)
        .text(`${bancolombiaData.number}`, currentX + 80, textY + 28)
        .text(`${bancolombiaData.name}`, currentX + 80, textY + 38)
        .text(`${bancolombiaData.cc}`, currentX + 80, textY + 48);
    }
